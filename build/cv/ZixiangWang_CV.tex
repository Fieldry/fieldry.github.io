...
\textbf{Google Scholar:} \href{https://scholar.google.com/citations?user=U73PSFAAAAAJ}{333 citations}
\end{center}
\vspace{-0.4mm}

\sectiontitle{Research Interest}
{\small I am a master's student at Peking University , advised by Prof. Liantao Ma and Prof. Yasha Wang. My research focuses on AI for Healthcare , especially medical large language models, electronic health record modeling, multi-agent collaboration, and reusable benchmark/toolkit infrastructure for clinical data analysis.\par}
...
\educationentry{\textbf{Peking University 北京大学}}{2024.09 - Present}{School of Software and Microelectronics · M.Eng. in Software Engineering}{    {\small Working on AI for Healthcare, medical large language models, and EHR modeling under the supervision of Prof. Liantao Ma and Prof. Yasha Wang.\par}}
\educationentry{\textbf{Beihang University 北京航空航天大学}}{2019.09 - 2024.06}{School of Software · B.Eng. in Software Engineering}{    {\small GPA: 3.83 (Rank: 9/187, Top 5\%).\par}
    {\small Completed systematic training in software engineering and gradually shifted toward data modeling, machine learning, and healthcare AI research.\par}}
...
{Yinghao Zhu$^{\ast}$, Lei Gu$^{\ast}$, \textbf{Zixiang Wang}$^{\ast}$, Haoran Sang, Dehao Sui, Wen Tang, Lan Mi, Yasha Wang, Junyi Gao, Liang Yao, Tianfan Fu, Ewen Harrison, Lequan Yu$^{\dagger}$, Liantao Ma$^{\dagger}$}
{Preprint}
{2026}
...
\cvitem{Reviewer}{, \cvdetail{AAAI 2026, 2027}}{2025, 2026}
\cvitem{Reviewer}{, \cvdetail{npj Digital Medicine}}{2026}
\cvitem{Reviewer}{, \cvdetail{npj Health Systems}}{2026}
\cvitem{Reviewer}{, \cvdetail{Scientific Reports}}{2026}
