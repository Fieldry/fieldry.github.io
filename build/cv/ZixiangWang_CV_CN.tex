...
\sectiontitle{研究方向}
{\small 我是北京大学软件与微电子学院硕士研究生，导师为马连韬教授和王亚沙教授。我的研究方向为医疗健康人工智能，重点关注医疗大语言模型及多智能体协作应用、时序电子病历数据建模，以及面向临床数据分析的可复用基准与工具基础设施。\par}
\begin{enumerate}[label=(\arabic*)]
\item {\small\textbf{医疗大语言模型}：构建并评估面向临床预测、推理、检索和决策支持的大语言模型驱动的多智能体系统。}
